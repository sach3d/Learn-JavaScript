<!-- <?php
    ...
    if (isset($_POST['submit'])) {
        ...
        $from = $_POST['email'];
        $to = '2balanced@gmail.com';
        $subject = 'Inform me';
        $body = 'Please let me know when site will be available';
    ...
    <body>
        ...
        <section id="intro">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <p>We're working hard, we'll be ready soon</p>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <ul class="list-inline">
                            <a href="https://twitter.com/sach3d" target="_blank">
                                <li class="list-inline-item">
                                    <i class="fa twitter fa-twitter-square fa-3x" aria-hidden="true"></i>
                                </li>
                            </a>
                            <a href="https://www.facebook.com/oleksandr.tymchenko.7" target="_blank">
                                <li class="list-inline-item">
                                    <i class="fa facebook fa-facebook-square fa-3x" aria-hidden="true"></i>
                                </li>
                            </a>
                            <a href="https://plus.google.com/+AleksanderTymczenko" target="_blank">
                                <li class="list-inline-item">
                                    <i class="fa google fa-google-plus-square fa-3x" aria-hidden="true"></i>
                                </li>
                            </a>
                            <a href="https://www.linkedin.com/in/aleksander-tymczenko-b80a2a74/" target="_blank">
                                <li class="list-inline-item">
                                    <i class="fa linkedin fa-linkedin-square fa-3x" aria-hidden="true"></i>
                                </li>
                            </a>
                        </ul>
                    </div>
